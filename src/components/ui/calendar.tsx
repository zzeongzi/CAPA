  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        // Removed [&:has([aria-selected])]:bg-accent to prevent cell background on selected date
        ...
        day_today: "bg-blue-200 text-blue-800 rounded-md", // 오늘 날짜 배경색 및 텍스트 색상 변경, 둥근 모서리 추가
        day_outside:
